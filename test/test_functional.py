...
from testutils import BUFSIZE
from testutils import configure_logging
from testutils import disable_log_warning
...
from testutils import safe_rmdir
from testutils import SUPPORTS_IPV4
from testutils import SUPPORTS_IPV6
from testutils import SUPPORTS_SENDFILE
from testutils import TESTFN
from testutils import TESTFN_UNICODE
from testutils import TESTFN_UNICODE_2
...
class TestConfigurableOptions(unittest.TestCase):
    ...
    def test_max_connections(self):
        ...
        try:
            ...
            c1.login(USER, PASSWD)
            with contextlib.closing(c1.makeport()) as sock:
                sock.settimeout(TIMEOUT)
                self.assertRaises(
